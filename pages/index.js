                ...
                <form>
                  <div className="input-box">
                    ...
                    <select id="typeitem">
                      ...
                      <option value="35">Hausarbeit / Seminararbeit</option>
                      <option value="39">Bachelorthesis</option>
                      <option value="45">Masterthesis</option>
                    </select>
                  </div>
                  <div className="input-box">
