...
const Datenschutzerklarung = () => {
  ...
  return (
    <>
      <section className="writern-sec-1 contanier">
        <div className="contanierfix">
          ...
          <p>
            I. Informationen über uns als Verantwortliche<br></br>II. Rechte der
            Nutzer und Betroffenen<br></br>III. Informationen zur
            Datenverarbeitung
          </p>
          ...
          <p>
            <Link href="https://www.ratgeberrecht.eu/leistungen/muster-datenschutzerklaerung.html"
              target="_blank"
              rel="noreferrer">
              <a>Muster-Datenschutzerklärung</a>
            </Link>
            der{" "}
            <Link href="https://www.ratgeberrecht.eu/datenschutz/datenschutzerklaerung-generator-dsgvo.html"
              target="_blank"
              rel="noreferrer">
              <a>Anwaltskanzlei Weiß &amp; Partner</a>
            </Link>
          </p>
        </div>
      </section>
